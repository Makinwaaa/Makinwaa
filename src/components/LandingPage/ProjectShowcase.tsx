...
const allProjects = [
    {
        ...
        description: "A premium real estate marketplace tailored for the Canadian market. Designed to make renting, buying, and selling properties as seamless as moving in.",
    ...
    },
    {
        ...
        year: "2026",
        category: "Web Application",
        description: "An intelligent discovery engine designed to curate personalized content. It analyzes user behavior to deliver tailored, high-converting recommendations instantly.",
    ...
    },
    {
        ...
        year: "2025",
        category: "Web Application",
        description: "A civic-tech solution streamlining tax compliance. It empowers governments with robust revenue management tools and simplifies collections through designated field agents.",
    ...
    },
    {
        ...
        description: "A dynamic ride-hailing app connecting drivers and riders. Built for speed, safety, and reliability to help people move around effortlessly while drivers earn on the go.",
    ...
    },
    {
        ...
        year: "2025",
        category: "Mobile Application",
        description: "A borderless fintech platform simplifying cross-border remittances. Quiva enables users to send money from the UK to Nigeria with zero friction and maximum security.",
    ...
    },
    {
        ...
        year: "2025",
        category: "Web Application",
        description: "A robust enterprise workspace that centralizes project tracking and team collaboration. Designed to bring clarity to complex workflows and boost overall productivity.",
    ...
    },
    {
        ...
        year: "2025",
        category: "Web Application",
        description: "A comprehensive human resource management suite. It streamlines payroll processing, talent onboarding, and employee experiences into one beautifully cohesive platform.",
    ...
    },
    {
        ...
        year: "2025",
        category: "Mobile Application",
        description: "A peer-to-peer car-sharing ecosystem with a lucrative twist. It transforms idle vehicles into passive income by letting owners lease out their cars securely to verified drivers.",
    ...
    },
    {
        ...
        year: "2022",
        category: "Mobile Application",
        description: "A telemedicine pioneer born during the pandemic. DokRx bridges the gap between patients and practitioners, enabling comfortable virtual consultations and seamless payouts.",
